				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewCommlabel" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.commlabels" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box table-responsive">
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									<td>${d.commlabelname}</td>
									<c:if test='${fn:contains(arrayPermisos, ePermiso )}'>
									<td class="tac">
										<a href="#" id="${d.commlabelid}" data-toggle="modal" data-target="#edit-commlabel-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.commlabelid}" onclick="deleteCommlabel(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="commlabel-modal" class="modal-demo">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="commlabel" class="supLlb"><fmt:message key='text.commlabel' /></label>
								<input type="text" class="form-control c39c" id="commlabel" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
			</form>
			<button type="button" onclick="return addCommlabel(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addCommlabelCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-commlabel-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-commlabel-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="commlabel.update" /></h4>
				<input type="hidden" id="edCommlabelId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edCommlabel" class="supLlb"><fmt:message key='text.commlabel' /></label>
								<input type="text" class="form-control c39c" id="edCommlabel" autocomplete="off">
							</div>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button type="button" onclick="return updateCommlabel();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/commlabels.js"></script>
