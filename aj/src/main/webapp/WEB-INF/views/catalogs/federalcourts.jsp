...
<style>
    ...
    .ddListImg{position:absolute;display:none;width:100%;max-height:30vh;min-height:100px;top:40px;
    	overflow-y:auto;-webkit-box-shadow:0 0 15px #aaa;box-shadow:0 0 15px #aaa;background-color:#fff;z-index:21}
    ...
    .noimgOnList li{display:block;min-height:34px;padding:0 10px}
    .ddOptDet{font-size:12px;color:#fff;text-shadow:-1px 1px 0 #888}
		...
		<div class="container">
			<div class="row"><!-- Page-Title -->
				<div class="col-sm-12">
					...
					<h4 class="page-title capitalize"><fmt:message key="text.districtcourt" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<input type="hidden" id="edCourtId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edCourt" class="supLlb"><fmt:message key='text.court' /></label>
								<input type="text" class="form-control c39c" id="edCourt" autocomplete="off">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
							<label for="edCitycourt" class="supLlb"><fmt:message key='text.city' /></label>
							<div class="form-group inlineflex w100p">
								<input type="text" class="form-control listfiltersel" placeholder="<fmt:message key="text.select" />" >
								<i class="material-icons iconlistfilter">arrow_drop_down</i>
								<ul class="ddListImg noimgOnList" id="edCitycourt"></ul>
							</div>
						</div>
					</div>
				</form>
...
<script src="resources/assets/js/federalcourts.js"></script>
