				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewJrdOrgan" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.jurisdictionalorgans" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box table-responsive">
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							<thead>
								<tr>
									<th><fmt:message key="text.jurisdictionalorgan" /></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${d.organoid}" data-toggle="modal" data-target="#edit-jrdorgan-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.organoid}" onclick="deleteJrdOrgan(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="jrdorgan-modal" class="modal-demo">
	...
	<div class="custom-modal-text text-left">
		<div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="jrdorgan" class="supLlb"><fmt:message key='text.jurisdictionalorgan' /></label>
								<input type="text" class="form-control c39c" id="jrdorgan" autocomplete="off">
							</div>
						</div>
						<div class="col-xs-12 col-sm-12">
							<label for="city" class="supLlb"><fmt:message key='text.firm' /></label>
			...
			<button type="button" onclick="return addJrdOrgan(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addJrdOrganCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-jrdorgan-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-jrdorgan-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="jurisdictionalorgan.update" /></h4>
				<input type="hidden" id="edJrdOrganId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edJrdOrgan" class="supLlb"><fmt:message key='text.jurisdictionalorgan' /></label>
								<input type="text" class="form-control c39c" id="edJrdOrgan" autocomplete="off">
							</div>
						</div>
						<div class="col-xs-12 col-sm-12">
							<label for="edCity" class="supLlb"><fmt:message key='text.firm' /></label>
							<div class="form-group fieldinfo inlineblock w100p">
								<input type="text" class="form-control listfiltersel" placeholder="<fmt:message key="text.select" />" >
								<i class="material-icons iconlistfilter">arrow_drop_down</i>
								<ul class="ddListImg noimgOnList" id="edCity"></ul>
							</div>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button type="button" onclick="return updateJrdOrgan();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/jrdorgans.js"></script>
