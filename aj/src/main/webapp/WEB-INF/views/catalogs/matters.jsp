				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewMatter" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.matters" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
						...
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${d.materiaid}" data-toggle="modal" data-target="#edit-matter-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.materiaid}" onclick="deleteMatter(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="matter-modal" class="modal-demo">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								...
								<input type="text" class="form-control c39c" id="matter" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
			</form>
			<button type="button" onclick="return addMatter(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addMatterCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-matter-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-matter-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="matter.update" /></h4>
				<input type="hidden" id="edMatterId">
			</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								...
								<input type="text" class="form-control c39c" id="edMatter" autocomplete="off">
							</div>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button type="button" onclick="return updateMatter();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/matter.js"></script>
