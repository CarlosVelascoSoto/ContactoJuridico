				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewOrganType" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.organtypes" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box table-responsive">
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							<thead>
								<tr>
									<th><fmt:message key="text.organtype" /></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${d.tipoorganoid}" data-toggle="modal" data-target="#edit-organtype-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.tipoorganoid}" onclick="deleteOrganType(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="organtype-modal" class="modal-demo">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="organtype" class="supLlb"><fmt:message key='text.organtype' /></label>
								<input type="text" class="form-control c39c" id="organtype" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
			</form>
			<button type="button" onclick="return addOrganType(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addOrganTypeCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-organtype-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-organtype-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="organtype.update" /></h4>
				<input type="hidden" id="edOrganTypeId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edOrganType" class="supLlb"><fmt:message key='text.organtype' /></label>
								<input type="text" class="form-control c39c" id="edOrganType" autocomplete="off">
							</div>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button type="button" onclick="return updateOrganType();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/organtypes.js"></script>
