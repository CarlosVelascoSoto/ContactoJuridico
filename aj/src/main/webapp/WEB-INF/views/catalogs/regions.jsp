				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewRegion" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.regions" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box table-responsive">
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							<thead>
								<tr>
									<th><fmt:message key="text.region" /></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${d.regionid}" data-toggle="modal" data-target="#edit-region-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.regionid}" onclick="deleteRegion(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="region-modal" class="modal-demo">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="region" class="supLlb"><fmt:message key='text.region' /></label>
								<input type="text" class="form-control c39c" id="region" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
			</form>
			<button type="button" onclick="return addRegion(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addRegionCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-region-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-region-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="region.update" /></h4>
				<input type="hidden" id="edRegionId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edRegion" class="supLlb"><fmt:message key='text.region' /></label>
								<input type="text" class="form-control c39c" id="edRegion" autocomplete="off">
							</div>
						</div>
					</div>
				</form>
			...
			<div class="modal-footer">
				<button type="button" onclick="return updateRegion();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/regions.js"></script>
