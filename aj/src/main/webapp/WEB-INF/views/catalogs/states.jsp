				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewState" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.states" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
						...
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${s.estadoid}" data-toggle="modal" data-target="#edit-state-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${s.estadoid}" onclick="deleteState(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="state-modal" class="modal-demo">
	...
	<div class="custom-modal-text text-left">
		<div class="panel-body">
			...
			<button type="button" onclick="return addState(this);" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addStateCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-state-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-state-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="state.update" /></h4>
				<input type="hidden" id="edStateId">
			</div>
				...
				<form id="formsnedit">
					...
					<div class="col-xs-12">
						...
						<div class="form-group fieldinfo inlineblock w100p">
							<input type="text" class="form-control listfiltersel" placeholder="<fmt:message key="text.select" />">
							<i class="material-icons iconlistfilter">arrow_drop_down</i>
							<ul class="ddListImg noimgOnList" id="edCountry"></ul>
						</div>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button type="button" onclick="return updateState();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/states.js"></script>
