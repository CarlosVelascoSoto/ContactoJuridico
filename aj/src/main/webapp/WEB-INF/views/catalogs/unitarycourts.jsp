				...
				<div class="col-sm-12">
					<c:if test='${fn:contains(arrayPermisos, aPermiso )}'>
 						<div class="btn-group pull-right m-t-15">
 							<a href="#" id="addNewUnitaryCourt" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200"
 								data-overlayColor="#36404a" class="btn btn-default btn-md waves-effect waves-light m-b-30 w-lg"> 
								<fmt:message key="button.new" />
							</a>
						</div>
					</c:if>
					<h4 class="page-title capitalize"><fmt:message key="text.unitarycourts" /></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box table-responsive">
						<table id="datatable-buttons" data-order='[[1,"desc"]]' class="table table-striped table-bordered">
							<thead>
								<tr>
									<th><fmt:message key="text.unitarycourt" /></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="tac">
										<a href="#" id="${d.tribunalUnitarioid}" data-toggle="modal" data-target="#edit-unitarycourt-modal" 
									...
									<td class="tac">
										<a href="#" class="table-action-btn" id="${d.tribunalUnitarioid}" onclick="deleteUnitaryCourt(id);"><i class="md md-close"></i></a>
									</td>
									</c:if>
								</tr>
								</c:forEach>
...
<!-- Modal -->
<div id="unitarycourt-modal" class="modal-demo">
		...
		<div class="panel-body">
			<form id="formsnnew">
				<div class="form-group">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="unitarycourt" class="supLlb"><fmt:message key='text.unitarycourt' /></label>
								<input type="text" class="form-control c39c" id="unitarycourt" autocomplete="off">
							</div>
						</div>
					</div>
					<div class="col-xs-12">
					...
					<div class="col-xs-12">
						<label for="cityUnitCourt" class="supLlb"><fmt:message key='text.city' /></label>
						<div class="form-group inlineflex w100p">
							<input type="text" class="form-control listfiltersel" onfocus="getCitiesByState('cityUnitCourt','ul',$('#statecourt li.selected').val());" placeholder="<fmt:message key="text.select" />" >
							<i class="material-icons iconlistfilter">arrow_drop_down</i>
							<ul class="ddListImg noimgOnList" id="cityUnitCourt"></ul>
						</div>
					</div>
				</div>
			</form>
			<button type="button" onclick="return addUnitaryCourt();" class="btn btn-default waves-effect waves-light">
				<fmt:message key="button.save" />
			</button>
			<button type="button" onclick="Custombox.close();" id="addUnitaryCourtCancel" class="btn btn-danger waves-effect waves-light m-l-10">
...
<div id="edit-unitarycourt-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="edit-unitarycourt-modal" aria-hidden="true" style="display:none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title capitalize"><fmt:message key="unitarycourt.update" /></h4>
				<input type="hidden" id="edUnitaryCourtId">
			</div>
			<div class="modal-body">
				<form id="formsnedit">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group inlineflex w100p">
								<label for="edUnitaryCourt" class="supLlb"><fmt:message key='text.unitarycourt' /></label>
								<input type="text" class="form-control c39c" id="edUnitaryCourt" autocomplete="off">
							</div>
						</div>
					</div>
					<div class="col-xs-12">
					...
					<div class="col-xs-12">
						<label for="edCityUnitCourt" class="supLlb"><fmt:message key='text.city' /></label>
						<div class="form-group inlineflex w100p">
							<input type="text" class="form-control listfiltersel"
								onfocus="getCitiesByState('edCityUnitCourt','ul',$('#edStatecourt li.selected').val());optImgListIcon($('#edCityUnitCourt'));"
								placeholder="<fmt:message key="text.select" />" >
							<i class="material-icons iconlistfilter">arrow_drop_down</i>
							<ul class="ddListImg noimgOnList" id="edCityUnitCourt"></ul>
						</div>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button type="button" onclick="return updateUnitaryCourt();" class="btn btn-default waves-effect waves-light">
					<fmt:message key="button.save" />
				</button>
...
<script src="resources/assets/js/unitarycourts.js"></script>
