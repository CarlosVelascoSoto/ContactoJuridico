...
<title><fmt:message key="text.protection"/>: ${amparo[0].amparo} - Contacto jur&iacute;dico</title>
				...
				<div class="card-box">
							...
							<thead>
								<tr>
									<th class="blueTitle" colspan="4">
										<span class="capitalize" style="padding-left:10px"><fmt:message key='text.protection'/></span><br>
					...
					<div style="margin:10px 0">
						<table class="w100p">
							<thead>
								<tr>
									<th>
										<h3 class="blueTitle capitalize" style="padding-left:10px">
											<c:choose>
												<c:when test="${not empty appeal[0].toca}">
													<fmt:message key='text.originappeal'/>
												</c:when>
												<c:otherwise>
													<fmt:message key='trial.origin'/>
												</c:otherwise>
											</c:choose>
										</h3>
									</th>
							...
							<tbody style="border-radius:2px;border:1px solid #eee">
								<tr>
									<td>
										<c:choose>
											<c:when test="${not empty appeal[0].toca}">
												${juicio[0].juicio} &emsp;<fmt:message key="text.handle"/> ${appeal[0].toca} ${juzgado[0].juzgado} ${materia[0].materia} ${ciudad[0].ciudad}
											</c:when>
											<c:otherwise>
												${juicio[0].juicio}
											</c:otherwise>
						...
						<table class="w100p">
							<tbody style="border-radius:2px;border:1px solid #eee">
								<tr style="font-weight:bold;border-collapse:collapse;border-bottom:1px solid #aaa">
									...
									<td><fmt:message key='text.stay'/></td>
								</tr>
								<tr>
									<td>
										<c:choose>
					...
					<div style="margin:25px 0">
						<table class="w100p">
							<tbody style="border-radius:2px;border:1px solid #eee">
								<tr style="font-weight:bold;border-collapse:collapse;border-bottom:1px solid #aaa">
									<td><fmt:message key="text.adhesiveaPtDate" /></td>
									<td><fmt:message key='text.dateshiftpresent'/></td>
									<td><fmt:message key='text.datesessjudgment'/></td>
									<td><fmt:message key='text.judgmentdate'/></td>
									<td><fmt:message key='text.judgmentnotifdate'/></td>
									<td><fmt:message key='text.reviewresourcedate'/></td>
								</tr>
								<tr>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fechaamparodirectoadhesivo}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fechaamparodirectoadhesivo}" /></c:otherwise>
										</c:choose>
									</td>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fechaturnoaponencia}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fechaturnoaponencia}" /></c:otherwise>
										</c:choose>
									</td>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fechasesionproyectosentencia}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fechasesionproyectosentencia}" /></c:otherwise>
										</c:choose>
									</td>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fechasentencia}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fechasentencia}" /></c:otherwise>
										</c:choose>
									</td>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fechanotificacionsentencia}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fechanotificacionsentencia}" /></c:otherwise>
										</c:choose>
									</td>
									<td>
										<c:choose>
											<c:when test="${language=='es'}"><fmt:formatDate pattern="dd MMM yyyy" value="${amparo[0].fecharecursorevision}" /></c:when>
											<c:otherwise><fmt:formatDate pattern="MMM dd yyyy" value="${amparo[0].fecharecursorevision}" /></c:otherwise>
										</c:choose>
									</td>
								</tr>
							</tbody>
								...
								<c:forEach var="j" items="${juicio}">
									<tr>
										<td><a class="asLink c39c trn2ms" title="<fmt:message key="text.viewdetails" />"
											href="trialsdashboard?language=${language}&rid=${j.juicioid}">${j.juicio}</a></td>
