...
<title><fmt:message key="text.consultation"/>: ${client[0].client} - Contacto jur&iacute;dico</title>
						...
						<thead>
							<tr>
								<th class="blueTitle capitalize" colspan="4">
									...
									<input type="hidden" id="referencetype" value="consultaid">
									<input type="hidden" id="referenceid" value="${cons.consultaid}">
								</th>
							</tr>
						</thead>
					...
					<table id="movList" data-order='[[1,"asc"]]' class="table table-striped table-bordered">
						<thead>
							<tr>
								...
								<th class="tac mxw100p"><fmt:message key="text.filingdate" /></th>
								<th class="tac mxw100p"><fmt:message key="text.agreementdate" /></th>
								<th class="tac mxw100p"><fmt:message key="text.notificationdate" /></th>
								<th class="tac"><fmt:message key="text.obserservations" /></th>
								<th class="tac"><fmt:message key="text.schedule" /></th>
...
<script src="resources/local/consultas/consultasdash.js"></script>
