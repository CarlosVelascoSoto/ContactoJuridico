...
<div class="row">
	<div class="col-xs-12 col-sm-4">
		<div class="form-group fieldinfo inlineblock w100p">
			<label for="trialConsList" class="supLlb"><fmt:message key='text.trial' /></label>
			<div class="form-group fieldinfo inlineblock w100p">
				<input type="text" class="form-control listfiltersel c39c" id="trialConsList"
					placeholder="<fmt:message key="text.select" />" >
				<i class="material-icons iconlistfilter">arrow_drop_down</i>
				<ul class="ddListImg noimgOnList" id="trialCons"></ul>
			</div>
		</div>
	</div>
	<div class="col-xs-12 col-sm-4">
		<label for="matterCons" class="supLlb"><em>* </em><fmt:message key='text.matter' /></label>
		<div class="form-group fieldinfo inlineblock w100p">
			<input type="text" class="form-control listfiltersel c39c" id="addMatterCons"
				onfocus="optImgListIcon(this);" placeholder="<fmt:message key="text.select" />">
			<i class="material-icons iconlistfilter">arrow_drop_down</i>
			<ul class="ddListImg noimgOnList" id="matterCons"></ul>
		</div>
	</div>
	<div class="col-xs-12 col-md-4">
		<div class="form-group fieldinfo inlineblock w100p">
			<label for="consFees" class="supLlb"><fmt:message key='text.proposedfees' /></label>
			<input type="number" class="form-control listfiltersel c39c" id="consFees" min="0" placeholder="0.00">
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="form-group fieldinfo inlineblock w100p">
			<label for="consultation" class="supLlb"><em>* </em><fmt:message key='text.consultations' /></label>
			<textarea class="form-control c39c" id="consultation"></textarea>
		</div>
	</div>
	<div class="col-xs-12">
		<div class="form-group fieldinfo inlineblock w100p">
			<label for="opinionCons" class="supLlb"><fmt:message key='text.opinion' /></label>
			<textarea class="form-control c39c" id="opinionCons"></textarea>
		</div>
	</div>
	<div class="col-xs-12">
		<div class="form-group fieldinfo inlineblock w100p">
			<label for="resumeCons" class="supLlb"><fmt:message key='text.summary' /></label>
			<textarea class="form-control c39c" id="resumeCons"></textarea>
		</div>
	</div>
</div>

<div class="row">
	<div id="areaAddConsUpload">
	...
	<div>
		<a data-toggle="modal" data-target="#camera-modal" class="btn-opencam flex trn2ms asLink noselect"
			onclick="$('#targetDZ').val('#uploadXAddCons')" title="<fmt:message key='text.usecam.browser' />" >
